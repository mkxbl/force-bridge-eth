...
pub async fn airdrop(
    ...
    let from_privkey = parse_privkey_path("0", &force_config, &network)?;
    ...
    for to_privkey in to_privkeys {
        let to_lockscript = parse_privkey(&to_privkey);
